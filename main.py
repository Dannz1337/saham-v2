...
*💾 FITUR BARU:* Data portfolio TERSIMPAN PERMANEN di SQLite!
"""
...
Sekarang dengan fitur **PORTFOLIO TRACKER + SQLITE**:

• 💾 *Data Permanen* - Portfolio gak ilang kalo bot restart!
...
def main():
    ...
    print("🤖 Initializing Bot Mentor Saham dengan SQLite Database...")
    ...
    print("✅ Bot Mentor Saham dengan SQLITE DATABASE berhasil diinisialisasi!")
    print("💾 Data portfolio tersimpan permanen di portfolio.db")
    print("🎯 Fitur: Portfolio Tracker, Pattern Recognition, Custom Screener, Trading Plan")
